...
class Application(QWidget):
    ...
    def CreateApp(self):
        ...
        #
        # # show the grid now, row numbers 0, 0, 0, 0, button 1 will tke one row and one column
        #
        # grid.addWidget(button1, 0, 0, 1,1)
        # grid.addWidget(button2, 0, 1, 1, 1)
        #
        # # button3 is in row 1 column 3
        # grid.addWidget(button3, 0, 2, 1, 1)
        #
        # # button4 is in row 2 column 1, it will take up one row and two columns
